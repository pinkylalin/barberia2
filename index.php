            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-md-block">
                        ...
                        <p>
                            Somos la mejor peluquería del Mundo, pinky lalin
                            <br>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="about_content" style="text-align: center;">
                    <h3 color="white">Estamos para ti</h3>
                    <h2>Somos tu Peluquería <br>Desde 2024</h2>
...
<section class="pricing_section" id="pricing" background="black">
